...
# documentation.
#
html_theme_options = {"collapse_navigation": True, "navigation_depth": 0}
...
latex_documents = [
    (master_doc, "pyflink.tex", "pyflink Documentation", [author], "manual"),
]
...
man_pages = [(master_doc, "pyflink", "pyflink Documentation", [author], 1)]
