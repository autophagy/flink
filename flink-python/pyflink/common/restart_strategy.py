...
class RestartStrategyConfiguration(object, metaclass=ABCMeta):
    ...
    def __eq__(self, other):
        return (
            ...
            and self._j_restart_strategy_configuration == other._j_restart_strategy_configuration
        )
...
class RestartStrategies(object):
    ...
    class NoRestartStrategyConfiguration(RestartStrategyConfiguration):
        ...
        def __init__(self, j_restart_strategy=None):
            if j_restart_strategy is None:
                ...
                super(RestartStrategies.NoRestartStrategyConfiguration, self).__init__(
                    self._j_restart_strategy_configuration
                )
            else:
                super(RestartStrategies.NoRestartStrategyConfiguration, self).__init__(
        ...
        def __init__(
            ...
            if j_restart_strategy is None:
                if not isinstance(delay_between_attempts_interval, (timedelta, int)):
                    raise TypeError(
                        "The delay_between_attempts_interval 'failure_interval' "
                        "only supports integer and datetime.timedelta, current input "
                        "type is %s." % type(delay_between_attempts_interval)
                    )
                gateway = get_gateway()
                self._j_restart_strategy_configuration = (
                    gateway.jvm.RestartStrategies.fixedDelayRestart(
                        restart_attempts, to_j_duration(delay_between_attempts_interval)
                    )
                )
                super(RestartStrategies.FixedDelayRestartStrategyConfiguration, self).__init__(
                    self._j_restart_strategy_configuration
                )
            else:
                super(RestartStrategies.FixedDelayRestartStrategyConfiguration, self).__init__(
        ...
        def __init__(
            ...
            if j_restart_strategy is None:
                if not isinstance(failure_interval, (timedelta, int)):
                    raise TypeError(
                        "The parameter 'failure_interval' "
                        "only supports integer and datetime.timedelta, current input "
                ...
                gateway = get_gateway()
                self._j_restart_strategy_configuration = (
                    gateway.jvm.RestartStrategies.FailureRateRestartStrategyConfiguration(
                        max_failure_rate,
                        to_j_duration(failure_interval),
                        to_j_duration(delay_between_attempts_interval),
                    )
                )
                super(RestartStrategies.FailureRateRestartStrategyConfiguration, self).__init__(
                    self._j_restart_strategy_configuration
                )
            else:
                super(RestartStrategies.FailureRateRestartStrategyConfiguration, self).__init__(
    ...
    class FallbackRestartStrategyConfiguration(RestartStrategyConfiguration):
        ...
        def __init__(self, j_restart_strategy=None):
            if j_restart_strategy is None:
                ...
                super(RestartStrategies.FallbackRestartStrategyConfiguration, self).__init__(
                    self._j_restart_strategy_configuration
                )
            else:
                super(RestartStrategies.FallbackRestartStrategyConfiguration, self).__init__(
    ...
    def _from_j_restart_strategy(j_restart_strategy) -> Optional[RestartStrategyConfiguration]:
        ...
        FixedDelayRestartStrategyConfiguration = (
            gateway.jvm.RestartStrategies.FixedDelayRestartStrategyConfiguration
        )
    ...
    @staticmethod
    def fixed_delay_restart(
        restart_attempts: int, delay_between_attempts: int
    ) -> "FixedDelayRestartStrategyConfiguration":
        """
        ...
        """
        return RestartStrategies.FixedDelayRestartStrategyConfiguration(
            restart_attempts, delay_between_attempts
        )

    @staticmethod
    def failure_rate_restart(
        failure_rate: int, failure_interval: int, delay_interval: int
    ) -> "FailureRateRestartStrategyConfiguration":
        """
        ...
        """
        return RestartStrategies.FailureRateRestartStrategyConfiguration(
            failure_rate, failure_interval, delay_interval
        )
