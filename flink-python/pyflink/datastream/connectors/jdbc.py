...
__all__ = ["JdbcSink", "JdbcConnectionOptions", "JdbcExecutionOptions"]
...
class JdbcSink(SinkFunction):
    ...
    def sink(
        ...
        output_format_clz = gateway.jvm.Class.forName(
        ...
        j_builder_method = output_format_clz.getDeclaredMethod(
            "createRowJdbcStatementBuilder", to_jarray(gateway.jvm.Class, [j_int_array_type])
        )
        ...
        jdbc_execution_options = (
            jdbc_execution_options
            if jdbc_execution_options is not None
            else JdbcExecutionOptions.defaults()
        )
        j_jdbc_sink = gateway.jvm.org.apache.flink.connector.jdbc.JdbcSink.sink(
            sql,
            j_statement_builder,
            jdbc_execution_options._j_jdbc_execution_options,
...
class JdbcConnectionOptions(object):
    ...
    class JdbcConnectionOptionsBuilder(object):
        ...
        def __init__(self):
            self._j_options_builder = get_gateway().jvm.org.apache.flink.connector.jdbc.JdbcConnectionOptions.JdbcConnectionOptionsBuilder()

        def with_url(self, url: str) -> "JdbcConnectionOptions.JdbcConnectionOptionsBuilder":
            self._j_options_builder.withUrl(url)
            return self

        def with_driver_name(
...
class JdbcExecutionOptions(object):
    ...
    def defaults() -> "JdbcExecutionOptions":
        return JdbcExecutionOptions(
            j_jdbc_execution_options=get_gateway().jvm.org.apache.flink.connector.jdbc.JdbcExecutionOptions.defaults()
        )
    ...
    class Builder(object):
        ...
        def __init__(self):
            self._j_builder = (
                get_gateway().jvm.org.apache.flink.connector.jdbc.JdbcExecutionOptions.builder()
            )
