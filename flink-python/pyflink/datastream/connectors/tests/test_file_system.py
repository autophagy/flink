...
class FileSystemTests(PyFlinkStreamingTestCase):
    ...
    def test_file_source(self):
        ...
        file_source = (
            file_source_builder.monitor_continuously(Duration.of_days(1))
        ...
        input_paths_field = load_java_class(
    ...
    def test_file_sink(self):
        ...
        file_sink = (
            file_sink_builder.with_bucket_check_interval(1000)
        ...
        buckets_builder_field = load_java_class(
        ...
        self.assertEqual(
            "SimpleStringEncoder", encoder_field.get(buckets_builder).getClass().getSimpleName()
        )
