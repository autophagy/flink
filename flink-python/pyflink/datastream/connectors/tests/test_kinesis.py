...
class FlinkKinesisTest(PyFlinkUTTestCase):
    ...
    def test_kinesis_streams_sink(self):
        ...
        self.assertEqual(
            get_field_value(kinesis_streams_sink.get_java_function(), "failOnError"), False
        )
        self.assertEqual(
    ...
    def test_kinesis_firehose_sink(self):
        ...
        self.assertEqual(
            get_field_value(kinesis_firehose_sink.get_java_function(), "failOnError"), False
        )
        self.assertEqual(
