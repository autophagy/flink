...
class StreamTableCalcTests(PyFlinkStreamTableTestCase):
    ...
    def test_where(self):
        ...
        query_operation = result._j_table.getQueryOperation()
        self.assertEqual(
            "and(" "greaterThan(a, 1), " "equals(b, 'Hello'))",
    ...
    def test_from_element(self):
        ...
        field_types = [
            ...
            DataTypes.ROW(
                [DataTypes.FIELD("a", DataTypes.BIGINT()), DataTypes.FIELD("b", DataTypes.DOUBLE())]
            ),
        ...
        schema = DataTypes.ROW(
            list(
                map(
                    lambda field_name, field_type: DataTypes.FIELD(field_name, field_type),
                    field_names,
                    field_types,
                )
            )
