...
class RowTimeDescriptorTests(PyFlinkTestCase):
    ...
    def test_timestamps_from_extractor(self):
        ...
        expected = {
            ...
            "rowtime.timestamps.class": "org.apache.flink.table.utils.TestingDescriptors$CustomExtractor",
            "rowtime.timestamps.serialized": "rO0ABXNyAD9vcmcuYXBhY2hlLmZsaW5rLnRhYmxlLnV0aWxzLlRlc3RpbmdEZXNjcmlwdG9ycyRDdXN0b2"
    ...
    def test_watermarks_from_strategy(self):
        ...
        expected = {
            ...
            "rowtime.watermarks.class": "org.apache.flink.table.utils.TestingDescriptors$CustomAssigner",
            "rowtime.watermarks.serialized": "rO0ABXNyAD5vcmcuYXBhY2hlLmZsaW5rLnRhYmxlLnV0aWxzLlRlc3RpbmdEZXNjcmlwdG9ycyRDdXN0b2"
...
class SchemaDescriptorTests(PyFlinkTestCase):
    ...
    def test_from_origin_field(self):
        schema = (
            ...
            .field("int_field", DataTypes.INT())
            .field("long_field", DataTypes.BIGINT())
            .from_origin_field("origin_field_a")
            .field("string_field", DataTypes.STRING())
        )
