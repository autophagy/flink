    ...
    def setUpClass(cls):
        ...
        cls.data = [
            (
                ...
                ["hello", "中文"],
                Row(a=1, b="hello", c=datetime.datetime(1970, 1, 1, 0, 0, 0, 123000), d=[1, 2]),
            ),
            (
                1,
                2,
...
class BatchPandasConversionTests(
    PandasConversionTests, PandasConversionITTests, PyFlinkBatchTableTestCase
):
    pass
