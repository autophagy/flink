...
class TableSchemaTests(PyFlinkTestCase):
    def test_init(self):
        schema = TableSchema(
            ["a", "b", "c"], [DataTypes.INT(), DataTypes.BIGINT(), DataTypes.STRING()]
        )
        ...
        self.assertEqual(
            [DataTypes.INT(), DataTypes.BIGINT(), DataTypes.STRING()], schema.get_field_data_types()
        )
    ...
    def test_builder(self):
        ...
        schema = (
            schema_builder.field("a", DataTypes.INT())
