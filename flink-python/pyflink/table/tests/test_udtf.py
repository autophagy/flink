...
class UserDefinedTableFunctionTests(object):
    def test_table_function(self):
        ...
        t = t.left_outer_join_lateral(condition_multi_emit(t.x, t.y).alias("m")).select(
            t.x, t.y, col("m")
        )
...
class PyFlinkStreamUserDefinedFunctionTests(
    UserDefinedTableFunctionTests, PyFlinkStreamTableTestCase
):
...
class PyFlinkBatchUserDefinedFunctionTests(
    UserDefinedTableFunctionTests, PyFlinkBatchTableTestCase
):
    pass
