...
public class TestingJobResultStore implements JobResultStore {
    ...
    private final FunctionWithException<JobID, JobResultEntry, ? extends IOException>
            getJobResultEntryFunction;
    ...
    private TestingJobResultStore(
            ...
            FunctionWithException<JobID, JobResultEntry, ? extends IOException>
                    getJobResultEntryFunction,
        ...
        this.getJobResultEntryFunction = getJobResultEntryFunction;
    ...
    public JobResultEntry getJobResultEntry(JobID jobId) throws IOException {
        return getJobResultEntryFunction.apply(jobId);
    }
    ...
    public static class Builder {
        ...
        private FunctionWithException<JobID, JobResultEntry, ? extends IOException>
                getJobResultEntryFunction =
                        jobId -> {
                            throw new IllegalArgumentException(
                                    "No JobResultEntry available for " + jobId);
                        };
        ...
        public Builder withGetJobResultEntryFunction(
                FunctionWithException<JobID, JobResultEntry, ? extends IOException>
                        getJobResultEntryFunction) {
            this.getJobResultEntryFunction = getJobResultEntryFunction;
            return this;
