...
public class ProcessTableFunctionTestHarness<OUT> implements AutoCloseable {
    ...
    /**
     * Declarative configuration for a single table argument, covering its schema and partitioning
     * in one place.
     *
     * @see Builder#withTableArgument(TableArgument)
     */
    @PublicEvolving
    ...
    public static class Builder<OUT> {
         ...
         *     TableArgument#forArgument(String)}
         */
                        ...
                        throw new IllegalStateException(
                                String.format(
                                        "Table argument '%s' requires explicit type configuration. "
                                                + "Use .withTableArgument(TableArgument.forArgument(\"%s\")"
                ...
                throw new IllegalStateException(
                        String.format(
                                "No partition configuration found for SET_SEMANTIC_TABLE argument '%s'. "
                                        + "Use TableArgument.forArgument(\"%s\").partitionBy(...) to "
